```markdown
# Role & Project Scope
You are an elite principal engineer specializing in Kotlin Multiplatform (KMP), Compose Multiplatform, and local-first peer-to-peer networking. We are building the foundational architecture for an app named **FileApex** (a local-first, decentralized, symmetrical file-explorer network for Android and macOS, with future iOS target capability).

# Core Technical Stack
- Project Name: FileApex
...
### Path: `shared/src/commonMain/kotlin/com/fileapex/data/db/FileApexDatabase.kt`
```kotlin
...
### Path: `shared/src/androidMain/kotlin/com/fileapex/data/db/FileApexDatabase.android.kt`
...
### Path: `shared/src/desktopMain/kotlin/com/fileapex/data/db/FileApexDatabase.desktop.kt`
...
actual class RoomDbBuilder {
    actual fun builder(): RoomDatabase.Builder<FileApexDatabase> {
        val dbFile = File(System.getProperty("user.home"), ".fileapex/fileapex.db")
...
### Path: `shared/src/commonMain/kotlin/com/fileapex/domain/model/RemoteFileItem.kt`
...
### Path: `shared/src/commonMain/kotlin/com/fileapex/network/FileApexServer.kt`
...
class FileApexServer(private val port: Int) {
...
### Path: `androidMain/kotlin/com/fileapex/network/FileShareServerService.kt`
...
class FileShareServerService : Service() {
    ...
    private val CHANNEL_ID = "FileApexServerChannel"
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        serverInstance = FileApexServer(port = 8080).apply { start() }
        return START_STICKY
    }
...
### Path: `shared/src/commonMain/kotlin/com/fileapex/ui/AdaptiveExplorerView.kt`
